...
install_dmp() {
    ...
    local dmp_urls=(
        "https://gh.b52m.cn/github.com/miracleEverywhere/dst-management-platform-api/releases/download/v3.2.0/dmp.tgz"
        "https://cdn.gh-proxy.org/github.com/miracleEverywhere/dst-management-platform-api/releases/download/v3.2.0/dmp.tgz"
        "https://ghproxy.homeboyc.cn/github.com/miracleEverywhere/dst-management-platform-api/releases/download/v3.2.0/dmp.tgz"
        "https://edgeone.gh-proxy.org/github.com/miracleEverywhere/dst-management-platform-api/releases/download/v3.2.0/dmp.tgz"
        "https://ghfast.top/github.com/miracleEverywhere/dst-management-platform-api/releases/download/v3.2.0/dmp.tgz"
    )
